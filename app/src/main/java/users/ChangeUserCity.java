...
public class ChangeUserCity extends AppCompatActivity implements RecyclerViewInterface {
...
//        ApplicationClass.setLocale(this,"en");
        ApplicationClass.loadLocale(ChangeUserCity.this);
        setContentView(R.layout.activity_change_user_city);
        ...
        custumProgressDialog=new CustumProgressDialog(ChangeUserCity.this);
setUserData();
    ...
    private void setUserData() {
        db.collection(ApplicationClass.LANGUAGE_MODE+"users").document(mAuth.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()) {
                    User user = documentSnapshot.toObject(User.class);

                    tvUserCity.setText(user.getUcity());
                    tvUserCountry.setText(user.getUcountry());
                    tvUserState.setText(user.getUstate());
                }
            }
        });
    }
...
//        final String userCity = tvUserCity.getText().toString();
    ...
    public void showBottomSheet(final String type)
    {
        bottomSheetDialog=new BottomSheetDialog(
                ChangeUserCity.this,R.style.AppBottomSheetDialogTheme
        );
        View bottomSheetView= LayoutInflater.from(ChangeUserCity.this)
                .inflate(
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ChangeUserCity.this));
        setData(type);
    ...
    private void setData(String type) {
        ...
        AddressAdapter adapter=new AddressAdapter(ChangeUserCity.this,this,list,type);
